...
// 1. Method / verd  -> This is used to indicate the type of request to the receiving applicstion.
...
//3. Header   -> header contains the metadata about the request to help it to be processed. 
//		         Cookies are held in the headers of request	
//4. Body     -> Contains any information that server will need to fulfill the request.
		
		
		
//		 HTTP Response : 3 major parts 
//		 1.Header       -> contains metadatsa about response. sometimes cookies to be sent with followup reques.
//		                   browser will automatically handle these.		
